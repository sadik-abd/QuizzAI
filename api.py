...
async def gen_feedback(data : FeedbackSchema):
    try:
        ...
        outp = model.feedback_qna(data.user_answers, json.load(open(saved_path,"r",encoding="utf-8"))["user"],histpath=saved_path,bighist=json.load(open(saved_path,"r",encoding="utf-8")))
